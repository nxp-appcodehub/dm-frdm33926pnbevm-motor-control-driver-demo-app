...
gpioHandleKSDK_t D18 = {.base = GPIO4, .pinNumber = 0, .mask = 1 << (0), .clockName = kCLOCK_Gpio4, .portNumber = 4};
gpioHandleKSDK_t D5 = {.base = GPIO2, .pinNumber = 7, .mask = 1 << (7), .clockName = kCLOCK_Gpio2, .portNumber = 2};
gpioHandleKSDK_t D6 = {.base = GPIO2, .pinNumber = 3, .mask = 1 << (3), .clockName = kCLOCK_Gpio2, .portNumber = 2};
gpioHandleKSDK_t A3 = {.base = GPIO0, .pinNumber = 22, .mask = 1 << (22), .clockName = kCLOCK_Gpio0, .portNumber = 0};

gpioHandleKSDK_t D2 = {.base = GPIO0, .pinNumber = 29, .mask = 1 << (29), .clockName = kCLOCK_Gpio0, .portNumber = 0};
gpioHandleKSDK_t D1 = {.base = GPIO4, .pinNumber = 2, .mask = 1 << (2), .clockName = kCLOCK_Gpio4, .portNumber = 4};
