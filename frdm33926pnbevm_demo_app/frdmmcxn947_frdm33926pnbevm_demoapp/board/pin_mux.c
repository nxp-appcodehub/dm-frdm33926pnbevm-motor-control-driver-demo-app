...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port2_7_pinF8_config = {/* Internal pull-up/down resistor is disabled */
    												 kPORT_PullUp,
    ...
    /* PORT2_7 (pin F8) IN1 (PWM1_B0) */
    PORT_SetPinConfig(PORT2, 7U, &port2_7_pinF8_config);

    const port_pin_config_t port2_3_pinF8_config = {/* Internal pull-up/down resistor is disabled */
													kPORT_PullDisable,
													/* Low internal pull resistor value is selected. */
													...
													/* Pin Control Register fields [15:0] are not locked */
													kPORT_UnlockRegister};
    /* PORT2_3 (pin F8) IN2 (PWM1_B2) */
    PORT_SetPinConfig(PORT2, 3U, &port2_3_pinF8_config);

	const port_pin_config_t port0_22_pin14_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT0, 22U, &port0_22_pin14_config);

	const port_pin_config_t port0_28_pin35_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT0, 28U, &port0_28_pin35_config);

	const port_pin_config_t port0_10_pin36_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT0, 10U, &port0_10_pin36_config);

	const port_pin_config_t port0_27_pin20_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT0, 27U, &port0_27_pin20_config);

	const port_pin_config_t port4_0_pin2_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT4, 0U, &port4_0_pin2_config);


	const port_pin_config_t port4_2_pin63_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT4, 2U, &port4_2_pin63_config);
	...
	const port_pin_config_t port4_0_pinU12_config = {/* Internal pull-up/down resistor is disabled */
	                                                      kPORT_PullDisable,
	                                                      /* Low internal pull resistor value is selected. */
	                                                      kPORT_LowPullResistor,
	                                                      /* Fast slew rate is configured */
	    ...
	    PORT_SetPinConfig(PORT4, 0U, &port4_0_pinU12_config);
